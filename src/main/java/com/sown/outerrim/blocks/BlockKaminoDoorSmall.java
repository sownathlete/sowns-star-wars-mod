...
public class BlockKaminoDoorSmall extends ORBlockContainer {

    public BlockKaminoDoorSmall(String name, Material material, float hardness, String toolType, int harvestLevel, Block.SoundType stepSound, boolean isMultiSided) {
        super(name, material);
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityKaminoDoorSmall();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        TileEntityKaminoDoorSmall tile = (TileEntityKaminoDoorSmall) world.getTileEntity(x, y, z);
