...
public class BlockKaminoRailing extends ORBlockContainer {

    public BlockKaminoRailing(String name, Material material, float hardness, String toolType, int harvestLevel, Block.SoundType stepSound, boolean isMultiSided) {
        super(name, material);
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityKaminoRailing();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        TileEntityKaminoRailing tile = (TileEntityKaminoRailing) world.getTileEntity(x, y, z);
