...
public class BlockVenatorBridgeChair extends ORBlockContainer {

    public BlockVenatorBridgeChair(String name, Material material, float hardness, String toolType, int harvestLevel, Block.SoundType stepSound, boolean isMultiSided) {
        super(name, material);
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityVenatorBridgeChair();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        TileEntityVenatorBridgeChair tile = (TileEntityVenatorBridgeChair) world.getTileEntity(x, y, z);
