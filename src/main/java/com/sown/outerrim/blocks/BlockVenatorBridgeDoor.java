...
public class BlockVenatorBridgeDoor extends ORBlockContainer {

    public BlockVenatorBridgeDoor(String name, Material material, float hardness, String toolType, int harvestLevel, Block.SoundType stepSound, boolean isMultiSided) {
        super(name, material);
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityVenatorBridgeDoor();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        TileEntityVenatorBridgeDoor tile = (TileEntityVenatorBridgeDoor) world.getTileEntity(x, y, z);
