...
public class BlockVenatorBridgeMechanicalTable extends ORBlockContainer {

    public BlockVenatorBridgeMechanicalTable(String name, Material material, float hardness, String toolType, int harvestLevel, Block.SoundType stepSound, boolean isMultiSided) {
        super(name, material);
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityVenatorBridgeMechanicalTable();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        TileEntityVenatorBridgeMechanicalTable tile = (TileEntityVenatorBridgeMechanicalTable) world.getTileEntity(x, y, z);
