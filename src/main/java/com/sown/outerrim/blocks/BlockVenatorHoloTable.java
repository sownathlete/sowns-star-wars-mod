...
public class BlockVenatorHoloTable extends ORBlockContainer {

    public BlockVenatorHoloTable(String name, Material material, float hardness, String toolType, int harvestLevel, Block.SoundType stepSound, boolean isMultiSided) {
        super(name, material);
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityVenatorHoloTable();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        TileEntityVenatorHoloTable tile = (TileEntityVenatorHoloTable) world.getTileEntity(x, y, z);
