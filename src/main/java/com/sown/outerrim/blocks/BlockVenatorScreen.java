...
public class BlockVenatorScreen extends ORBlockContainer {

    public BlockVenatorScreen(String name, Material material, float hardness, String toolType, int harvestLevel, Block.SoundType stepSound, boolean isMultiSided) {
        super(name, material);
    ...
    public TileEntity createNewTileEntity(World world, int metadata) {
        return new TileEntityVenatorScreen();
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemStack) {
        ...
        TileEntityVenatorScreen tile = (TileEntityVenatorScreen) world.getTileEntity(x, y, z);
