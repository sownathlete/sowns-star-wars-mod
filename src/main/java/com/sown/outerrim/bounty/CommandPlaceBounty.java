...
public class CommandPlaceBounty implements ICommand {
    ...
    public void processCommand(ICommandSender sender, String[] args) {
        ...
        if (args.length != 2) {
            ChatComponentText msg = new ChatComponentText("Usage: /bounty <player> <amount>");
        ...
        BountyManager.placeBounty(player, targetName, amount);
    }
