package com.sown.outerrim.dimension;
...
public class BiomeChunkProviderGenericPeaceful
extends ChunkProviderGenerate {
    ...
    public BiomeChunkProviderGenericPeaceful(World world, long seed, boolean features) {
