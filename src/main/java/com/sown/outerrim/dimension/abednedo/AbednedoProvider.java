...
public class AbednedoProvider
extends WorldProviderSpace{
    public static final BiomeGenBase abednedo = new BiomeGenAbednedo(OuterRimResources.ConfigOptions.biomeAbednedoId).setColor(112).setBiomeName("Abednedo");
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerAbednedo.class;
    }
