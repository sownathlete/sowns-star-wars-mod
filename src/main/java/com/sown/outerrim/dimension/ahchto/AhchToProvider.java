...
extends WorldProviderSpace{
    ...
    public static final BiomeGenBase ahchTo = new BiomeGenAhchTo(OuterRimResources.ConfigOptions.biomeAhchToId).setColor(112).setBiomeName("Ahch-To");
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderAhchTo.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerAhchTo.class;
    }
