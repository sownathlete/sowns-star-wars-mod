...
public class AjanKlossProvider
extends WorldProviderSpace{
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    public static final BiomeGenBase ajanKloss = new BiomeGenAjanKloss(OuterRimResources.ConfigOptions.biomeAjanKlossId).setColor(112).setBiomeName("The Klosslands");
    
    @SideOnly(value=Side.CLIENT)
    private IRenderHandler skyRenderer;

    static {
    	biomes.add(ajanKloss);
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderAjanKloss.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerAjanKloss.class;
    }
