...
public class GenLayerBiomeAlderaan extends GenLayer {

    public GenLayerBiomeAlderaan(long seed) {
        super(seed);
    }
    ...
    public static GenLayer[] makeTheWorld(long seed) {
        GenLayer biomes = new GenLayerAlderaanBiomes(1L);
