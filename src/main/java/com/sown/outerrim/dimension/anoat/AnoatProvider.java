...
public class AnoatProvider
extends WorldProviderSpace{
    public static final BiomeGenBase anoat = new BiomeGenAnoat(OuterRimResources.ConfigOptions.biomeAnoatId).setColor(112).setBiomeName("Anoat");
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerAnoat.class;
    }
