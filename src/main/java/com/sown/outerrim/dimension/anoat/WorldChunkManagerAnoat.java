...
public class WorldChunkManagerAnoat
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerAnoat() {
        this.biomesToSpawn.add(AnoatProvider.anoat);
    }

    public WorldChunkManagerAnoat(long seed) {
        this();
    }

    public WorldChunkManagerAnoat(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return AnoatProvider.anoat;
    }
