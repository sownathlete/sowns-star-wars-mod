...
public class GenLayerBiomeAurea extends GenLayer {
	public GenLayerBiomeAurea(long seed) {
		super(seed);
	}
		...
		for (int y = 0; y < areaHeight; y++) {
			for (int x = 0; x < areaWidth; x++) {
				...
				if (n < 20)
					...
					biomes[x + y * areaWidth] = BiomeGenBase.desert.biomeID;
				else if (n < 95)
	...
	public static GenLayer[] makeTheWorld(long seed) {
		GenLayer biomes = new GenLayerAureaBiomes(1L);
