...
public class WorldChunkManagerAurea extends DimensionHelperChunkMgr {
	...
	protected WorldChunkManagerAurea() {
		...
		biomesToSpawn.add(BiomeGenBase.desert);
	}

	public WorldChunkManagerAurea(long seed) {
		this();
		GenLayer[] agenlayer = GenLayerBiomeAurea.makeTheWorld(seed);
		this.unzoomedBiomes = agenlayer[0];
		this.zoomedBiomes = agenlayer[1];
	}

	public WorldChunkManagerAurea(World world) {
		this(world.getSeed());
	}
