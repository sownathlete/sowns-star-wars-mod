...
public class BahrynProvider
extends WorldProviderSpace{
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    public static final BiomeGenBase bahryn = (new BiomeGenBahryn(OuterRimResources.ConfigOptions.biomeBahrynId)).setColor(7580259).setBiomeName("Bahryn");
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderBahryn.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerBahryn.class;
    }
