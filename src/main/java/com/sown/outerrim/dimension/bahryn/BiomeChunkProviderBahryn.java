...
public class BiomeChunkProviderBahryn
extends ChunkProviderGenerate {
    ...
    public BiomeChunkProviderBahryn(World world, long seed, boolean features) {
    ...
    public Chunk provideChunk(int par1, int par2) {
        ...
        for (int i = 0; i < ablock.length; i++) {
            if (ablock[i] == Blocks.water) {
                ablock[i] = Blocks.snow; // Replace with air or any other block you prefer
            }
        }
