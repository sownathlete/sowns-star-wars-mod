...
public class WorldChunkManagerBahryn
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerBahryn() {
        this.biomesToSpawn.add(BahrynProvider.bahryn);
    }

    public WorldChunkManagerBahryn(long seed) {
        this();
    }

    public WorldChunkManagerBahryn(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return BahrynProvider.bahryn;
    }
