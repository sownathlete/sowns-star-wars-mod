...
public class BakuraProvider
extends WorldProviderSpace
implements WorldProviderHelper {
    public static final BiomeGenBase bakura = new BiomeGenBakura(OuterRimResources.ConfigOptions.biomeBakuraId).setColor(112).setBiomeName("Bakura");
    ...
    public void registerWorldChunkManager() {
        this.worldChunkMgr = new WorldChunkManagerBakura();
        this.dimensionId = OuterRimResources.ConfigOptions.dimBakuraId;
    }
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderBakura.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerBakura.class;
    }
