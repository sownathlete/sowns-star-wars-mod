...
public class WorldChunkManagerBakura
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerBakura() {
        this.biomesToSpawn.add(BakuraProvider.bakura);
    }

    public WorldChunkManagerBakura(long seed) {
        this();
    }

    public WorldChunkManagerBakura(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return BakuraProvider.bakura;
    }
