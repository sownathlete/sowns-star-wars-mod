...
public class GenLayerBespinBiomes
extends GenLayer {
    protected BiomeGenBase[] commonBiomes = new BiomeGenBase[]{BespinProvider.bespin};
    protected BiomeGenBase[] rareBiomes = new BiomeGenBase[]{BespinProvider.bespin};

    public GenLayerBespinBiomes(long seed, GenLayer genlayer) {
        super(seed);
        this.parent = genlayer;
    }

    public GenLayerBespinBiomes(long seed) {
        super(seed);
    }
