...
public class BestineProvider
extends WorldProviderSpace
implements WorldProviderHelper {
    public static final BiomeGenBase bestine = new BiomeGenBestine(OuterRimResources.ConfigOptions.biomeBestineId).setColor(112).setBiomeName("Bestine");
    ...
    public void registerWorldChunkManager() {
        this.worldChunkMgr = new WorldChunkManagerBestine();
        this.dimensionId = OuterRimResources.ConfigOptions.dimBestineId;
    }
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderBestine.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerBestine.class;
    }
