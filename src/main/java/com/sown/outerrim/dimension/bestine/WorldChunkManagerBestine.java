...
public class WorldChunkManagerBestine
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerBestine() {
        this.biomesToSpawn.add(BestineProvider.bestine);
    }

    public WorldChunkManagerBestine(long seed) {
        this();
    }

    public WorldChunkManagerBestine(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return BestineProvider.bestine;
    }
