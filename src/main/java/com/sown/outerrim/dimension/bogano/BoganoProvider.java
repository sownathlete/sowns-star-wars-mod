...
import com.sown.outerrim.dimension.geonosis.BiomeGenGeonosisMesa;
...
public class BoganoProvider
extends WorldProviderSpace{
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    protected static final BiomeGenBase.Height height_HighPlateaus = new BiomeGenBase.Height(1.2F, 0.0F);
    public static final BiomeGenBase BoganoPlains = new BiomeGenBogano(OuterRimResources.ConfigOptions.biomeBoganoId).setColor(112).setBiomeName("Bogano Mesa").setHeight(height_HighPlateaus);
    @SideOnly(value=Side.CLIENT)
    private IRenderHandler skyRenderer;

    static {
        biomes.add(BoganoPlains);
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderBogano.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerBogano.class;
    }
