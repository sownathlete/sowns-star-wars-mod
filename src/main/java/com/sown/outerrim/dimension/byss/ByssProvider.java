...
public class ByssProvider
extends WorldProviderSpace{
    public static final BiomeGenBase byss = new BiomeGenByss(OuterRimResources.ConfigOptions.biomeByssId).setColor(112).setBiomeName("Byss");
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerByss.class;
    }
