...
public class CaridaProvider
extends WorldProviderSpace{
    public static final BiomeGenBase carida = new BiomeGenCarida(OuterRimResources.ConfigOptions.biomeCaridaId).setColor(112).setBiomeName("Carida");
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderCarida.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerCarida.class;
    }
