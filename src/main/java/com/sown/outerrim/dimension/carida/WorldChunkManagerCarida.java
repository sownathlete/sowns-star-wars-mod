...
public class WorldChunkManagerCarida
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerCarida() {
        this.biomesToSpawn.add(CaridaProvider.carida);
    }

    public WorldChunkManagerCarida(long seed) {
        this();
    }

    public WorldChunkManagerCarida(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return CaridaProvider.carida;
    }
