...
public class WorldChunkManagerCorellia
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerCorellia() {
        this.biomesToSpawn.add(CorelliaProvider.corellia);
    }

    public WorldChunkManagerCorellia(long seed) {
        this();
    }

    public WorldChunkManagerCorellia(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return CorelliaProvider.corellia;
    }
