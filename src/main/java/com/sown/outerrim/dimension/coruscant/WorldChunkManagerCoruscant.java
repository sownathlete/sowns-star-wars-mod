...
public class WorldChunkManagerCoruscant
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerCoruscant() {
        this.biomesToSpawn.add(CoruscantProvider.coruscant);
    }

    public WorldChunkManagerCoruscant(long seed) {
        this();
    }

    public WorldChunkManagerCoruscant(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return CoruscantProvider.coruscant;
    }
