...
public class CsillaProvider
extends WorldProviderSpace{
    public static final BiomeGenBase csilla = new BiomeGenCsilla(OuterRimResources.ConfigOptions.biomeCsillaId).setColor(112).setBiomeName("Csilla");
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerCsilla.class;
    }
