...
public class WorldChunkManagerDeathStar
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerDeathStar() {
        this.biomesToSpawn.add(DeathStarProvider.deathStar);
    }

    public WorldChunkManagerDeathStar(long seed) {
        this();
    }

    public WorldChunkManagerDeathStar(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return DeathStarProvider.deathStar;
    }
