...
public class GenLayerEndorBiomes
extends GenLayer {
    protected BiomeGenBase[] commonBiomes = new BiomeGenBase[]{EndorProvider.endorTaiga, EndorProvider.megaEndorTaiga, EndorProvider.megaEndorTaigaHills};
    protected BiomeGenBase[] rareBiomes = new BiomeGenBase[]{BiomeGenBase.deepOcean};

    public GenLayerEndorBiomes(long seed, GenLayer genlayer) {
        super(seed);
        this.parent = genlayer;
    }

    public GenLayerEndorBiomes(long seed) {
        super(seed);
    }
