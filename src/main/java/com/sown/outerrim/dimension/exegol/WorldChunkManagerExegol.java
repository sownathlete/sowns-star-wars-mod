...
public class WorldChunkManagerExegol
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerExegol() {
        this.biomesToSpawn.add(ExegolProvider.exegol);
    }

    public WorldChunkManagerExegol(long seed) {
        this();
    }

    public WorldChunkManagerExegol(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return ExegolProvider.exegol;
    }
