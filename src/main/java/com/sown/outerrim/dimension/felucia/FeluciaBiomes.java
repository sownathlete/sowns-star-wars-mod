...
public class FeluciaBiomes
extends BiomeGenBase {
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    protected static final BiomeGenBase.Height height_low = new BiomeGenBase.Height(0.1F, 0.2F);
    protected static final BiomeGenBase.Height height_high = new BiomeGenBase.Height(1.5F, 0.4F);
    public static final BiomeGenBase feluciaJungle = new BiomeGenFeluciaJungle().setColor(112).setBiomeName("Felucia Jungle").setHeight(height_low);
    public static final BiomeGenBase feluciaHighlands = new BiomeGenFeluciaHighlands(OuterRimResources.ConfigOptions.biomeFeluciaHighlandsId).setColor(112).setBiomeName("Felucia Highlands").setHeight(height_high);
    ...
    static {
        biomes.add(feluciaJungle);
        biomes.add(feluciaHighlands);
        // Add other biomes as needed
    }

    public FeluciaBiomes(int id) {
        super(id);
    ...
    public BiomeDecorator createBiomeDecorator() {
        return new BiomeDecoratorFelucia();
    }

    protected BiomeDecoratorFelucia getBiomeDecorator() {
        return (BiomeDecoratorFelucia)this.theBiomeDecorator;
    }
