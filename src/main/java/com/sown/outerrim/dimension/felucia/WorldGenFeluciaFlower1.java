...
public class WorldGenFeluciaFlower1 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		place(world, x + 4, y + 0, z + 4, Blocks.wooden_slab, 5);
		place(world, x + 4, y + 0, z + 5, Blocks.stained_hardened_clay, 12);
		place(world, x + 4, y + 0, z + 6, fence_dark_oak, 0);
		place(world, x + 4, y + 1, z + 5, fence_dark_oak, 0);
		...
		place(world, x + 4, y + 16, z + 6, smooth_red_sandstone_slab, 8);
		place(world, x + 4, y + 17, z + 5, trapdoor_acacia, 2);
		...
		place(world, x + 5, y + 1, z + 6, Blocks.wooden_slab, 5);
		...
		place(world, x + 5, y + 16, z + 6, smooth_red_sandstone_slab, 8);
		place(world, x + 5, y + 16, z + 7, smooth_red_sandstone_slab, 0);
		place(world, x + 5, y + 17, z + 4, smooth_red_sandstone_stairs, 6);
		place(world, x + 5, y + 17, z + 5, smooth_red_sandstone_slab, 0);
		place(world, x + 5, y + 17, z + 6, Blocks.lever, 5);
		...
		place(world, x + 6, y + 16, z + 6, trapdoor_acacia, 11);
		place(world, x + 6, y + 17, z + 5, smooth_red_sandstone_slab, 0);
