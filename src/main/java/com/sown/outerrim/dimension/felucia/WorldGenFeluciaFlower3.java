...
public class WorldGenFeluciaFlower3 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		place(world, x + 4, y + 16, z + 4, trapdoor_acacia, 10);
		place(world, x + 4, y + 17, z + 5, smooth_red_sandstone_slab, 0);
		...
		place(world, x + 5, y + 1, z + 4, Blocks.wooden_slab, 5);
		...
		place(world, x + 5, y + 16, z + 3, smooth_red_sandstone_slab, 0);
		place(world, x + 5, y + 16, z + 4, smooth_red_sandstone_slab, 8);
		place(world, x + 5, y + 16, z + 5, red_sandstone_wall, 0);
		place(world, x + 5, y + 17, z + 4, Blocks.lever, 5);
		place(world, x + 5, y + 17, z + 5, smooth_red_sandstone_slab, 0);
		place(world, x + 5, y + 17, z + 6, smooth_red_sandstone_stairs, 7);
		place(world, x + 6, y + 0, z + 4, fence_dark_oak, 0);
		place(world, x + 6, y + 0, z + 5, Blocks.stained_hardened_clay, 12);
		place(world, x + 6, y + 0, z + 6, Blocks.wooden_slab, 5);
		place(world, x + 6, y + 1, z + 5, fence_dark_oak, 0);
		...
		place(world, x + 6, y + 16, z + 4, smooth_red_sandstone_slab, 8);
		place(world, x + 6, y + 17, z + 5, trapdoor_acacia, 3);
