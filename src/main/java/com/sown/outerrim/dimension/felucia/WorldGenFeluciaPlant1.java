...
public class WorldGenFeluciaPlant1 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		place(world, x + 1, y + 5, z + 2, Blocks.stained_hardened_clay, 12);
		...
		place(world, x + 2, y + 4, z + 1, Blocks.mossy_cobblestone, 0);
		...
		place(world, x + 2, y + 6, z + 2, Blocks.cobblestone_wall, 1);
		place(world, x + 2, y + 7, z + 1, Blocks.mossy_cobblestone, 0);
		place(world, x + 2, y + 8, z + 1, Blocks.cobblestone_wall, 1);
