...
public class WorldGenFeluciaPlantA1 extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, int x, int y, int z) {
		...
		place(world, x + 0, y + 2, z + 0, fence_gate_acacia, 0);
		place(world, x + 0, y + 3, z + 0, red_sandstone_wall, 0);
		place(world, x + 0, y + 4, z + 0, stone_slab, 1);
		place(world, x + 1, y + 0, z + 0, Blocks.stained_hardened_clay, 1);
		place(world, x + 1, y + 1, z + 0, Blocks.stained_hardened_clay, 1);
		place(world, x + 1, y + 2, z + 0, red_sandstone_wall, 0);
		place(world, x + 1, y + 3, z + 0, trapdoor_acacia, 11);
		place(world, x + 1, y + 4, z + 0, Blocks.carpet, 13);
