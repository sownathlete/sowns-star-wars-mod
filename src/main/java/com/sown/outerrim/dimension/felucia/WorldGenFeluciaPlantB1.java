...
public class WorldGenFeluciaPlantB1 extends WorldGenerator {
...
// --- Structure Placement ---
		...
		place(world, x + 1, y + 0, z + 2, blackstone_stairs, 0);
		place(world, x + 1, y + 1, z + 1, blackstone_wall, 0);
		place(world, x + 1, y + 6, z + 1, stone_slab, 9);
		place(world, x + 1, y + 7, z + 1, Blocks.carpet, 13);
		place(world, x + 2, y + 0, z + 0, blackstone_stairs, 2);
		place(world, x + 2, y + 0, z + 1, blackstone, 0);
		place(world, x + 2, y + 0, z + 2, blackstone, 0);
		place(world, x + 2, y + 1, z + 1, blackstone, 0);
		place(world, x + 2, y + 1, z + 2, blackstone_wall, 0);
		place(world, x + 2, y + 2, z + 1, Blocks.stained_hardened_clay, 1);
		place(world, x + 2, y + 3, z + 1, Blocks.stained_hardened_clay, 1);
		place(world, x + 2, y + 4, z + 1, Blocks.sand, 1);
		place(world, x + 2, y + 5, z + 1, fence_gate_acacia, 7);
		place(world, x + 2, y + 7, z + 1, stone_slab, 1);
		place(world, x + 3, y + 0, z + 1, blackstone_wall, 0);
		place(world, x + 3, y + 0, z + 2, blackstone_wall, 0);
		place(world, x + 3, y + 1, z + 1, fence_acacia, 0);
		place(world, x + 3, y + 4, z + 1, red_sandstone_wall, 0);
		place(world, x + 3, y + 5, z + 1, Blocks.stained_hardened_clay, 1);
		place(world, x + 3, y + 6, z + 1, red_sandstone_wall, 0);
		place(world, x + 3, y + 7, z + 1, Blocks.carpet, 13);
