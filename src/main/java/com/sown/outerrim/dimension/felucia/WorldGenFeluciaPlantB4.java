...
public class WorldGenFeluciaPlantB4 extends WorldGenerator {
...
// --- Structure Placement ---
		place(world, x + 0, y + 0, z + 1, blackstone_stairs, 0);
		place(world, x + 0, y + 0, z + 2, blackstone_wall, 0);
		place(world, x + 1, y + 0, z + 0, blackstone_wall, 0);
		place(world, x + 1, y + 0, z + 1, blackstone, 0);
		place(world, x + 1, y + 0, z + 2, blackstone, 0);
		place(world, x + 1, y + 1, z + 0, fence_acacia, 0);
		place(world, x + 1, y + 1, z + 1, blackstone, 0);
		place(world, x + 1, y + 1, z + 2, blackstone_wall, 0);
		place(world, x + 1, y + 2, z + 1, Blocks.stained_hardened_clay, 1);
		place(world, x + 1, y + 3, z + 1, Blocks.stained_hardened_clay, 1);
		place(world, x + 1, y + 4, z + 0, red_sandstone_wall, 0);
		place(world, x + 1, y + 4, z + 1, Blocks.sand, 1);
		place(world, x + 1, y + 5, z + 0, Blocks.stained_hardened_clay, 1);
		place(world, x + 1, y + 5, z + 1, fence_gate_acacia, 6);
		place(world, x + 1, y + 6, z + 0, red_sandstone_wall, 0);
		place(world, x + 1, y + 6, z + 2, stone_slab, 9);
		place(world, x + 1, y + 7, z + 0, Blocks.carpet, 13);
		place(world, x + 1, y + 7, z + 1, stone_slab, 1);
		place(world, x + 1, y + 7, z + 2, Blocks.carpet, 13);
		place(world, x + 2, y + 0, z + 0, blackstone_wall, 0);
		place(world, x + 2, y + 0, z + 1, blackstone, 0);
		place(world, x + 2, y + 0, z + 2, blackstone_stairs, 3);
