...
public class BiomeGenGeonosisMesa extends BiomeGenBase
{
    ...
    public BiomeGenGeonosisMesa(int p_i45380_1_, boolean p_i45380_2_, boolean p_i45380_3_)
    {
        super(p_i45380_1_);
        ...
        this.fillerBlock = BlockRegister.getRegisteredBlock("geonosisRock");
    ...
    public void decorate(World world, Random rand, int chunkX, int chunkZ) {
        ...
        // Geonosis Pillars1
        int pillarChance1 = 17; // adjust this to change the spawn frequency of Geonosis pillars.
        ...
        int pillarChance = 17; // adjust this to change the spawn frequency of Geonosis pillars.
    ...
    public void genTerrainBlocks(World p_150573_1_, Random p_150573_2_, Block[] p_150573_3_, byte[] p_150573_4_, int p_150573_5_, int p_150573_6_, double p_150573_7_)
    {
        ...
        l = p_150573_6_ & 15;
        boolean flag = true;
        Block block = BlockRegister.getRegisteredBlock("geonosisGravel");
                ...
                if (block1 != null && block1.getMaterial() != Material.air)
                {
                    if (block1 == Blocks.stone)
                    {
                        ...
                        if (j1 == -1)
                        {
                            ...
                            {
                                block = BlockRegister.getRegisteredBlock("geonosisSand");
                            ...
                            if (l1 >= 62)
                            {
                                if (this.field_150620_aI && l1 > 86 + i1 * 2)
                                {
                                    ...
                                    {
                                        p_150573_3_[i2] = BlockRegister.getRegisteredBlock("geonosisGravel");
                                    }
                                }
                                else if (l1 > 66 + i1)
                                {
                                    ...
                                    {
                                        // Top and floor
                                        p_150573_3_[i2] = BlockRegister.getRegisteredBlock("geonosisCobblestone");
                                        p_150573_4_[i2] = b0;
                                    }
                                    else
                                    {
                                        p_150573_3_[i2] = BlockRegister.getRegisteredBlock("geonosisRock");
                                    }
                                }
                                else
                                {
                            ...
                            else
                            {
                                ...
                                if (block2 == BlockRegister.getRegisteredBlock("geonosisSand"))
                                {
                                    p_150573_4_[i2] = 8;
                                }
                            }
                        ...
                        else if (j1 > 0)
                        {
                            ...
                            if (flag2)
                            {
                                p_150573_3_[i2] = BlockRegister.getRegisteredBlock("geonosisSand");
                                p_150573_4_[i2] = 10;
                            }
                            else
                            {
    ...
    public BiomeGenBase createMutation()
    {
        ...
        BiomeGenGeonosisMesa biomegenmesa = new BiomeGenGeonosisMesa(this.biomeID + 128, flag, this.field_150620_aI);
