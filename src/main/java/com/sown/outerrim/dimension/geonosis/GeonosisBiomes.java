...
public class GeonosisBiomes extends BiomeGenBase {
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    public static final BiomeGenBase geonosisDesert = new BiomeGenGeonosisDesert().setColor(112).setBiomeName("Geonosis Desert").setHeight(height_LowPlains);
    public static final BiomeGenBase geonosisGravelHills = new BiomeGenGeonosisGravelHills().setColor(112).setBiomeName("Geonosis Gravel Hills").setHeight(height_MidHills);
    public static final BiomeGenBase geonosisMesa = new BiomeGenGeonosisMesa(OuterRimResources.ConfigOptions.biomeGeonosisMesaId, false, false).setColor(112).setBiomeName("Geonosis Mesa").setHeight(height_HighPlateaus);
    ...
    static {
        biomes.add(geonosisDesert);
        biomes.add(geonosisGravelHills);
        biomes.add(geonosisMesa);
        // Add other biomes as needed
    }

    public GeonosisBiomes(int id) {
        super(id);
    ...
    public BiomeDecorator createBiomeDecorator() {
        return new BiomeDecoratorGeonosis();
    }

    protected BiomeDecoratorGeonosis getBiomeDecorator() {
        return (BiomeDecoratorGeonosis)this.theBiomeDecorator;
    }
