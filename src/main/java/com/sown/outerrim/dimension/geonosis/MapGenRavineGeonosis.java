...
public class MapGenRavineGeonosis
extends MapGenBase {
    ...
    protected void func_151540_a(long p_151540_1_, int p_151540_3_, int p_151540_4_, Block[] p_151540_5_, double p_151540_6_, double p_151540_8_, double p_151540_10_, float p_151540_12_, float p_151540_13_, float p_151540_14_, int p_151540_15_, int p_151540_16_, double p_151540_17_) {
        ...
        while (p_151540_15_ < p_151540_16_) {
            double d12 = 1.5 + MathHelper.sin(p_151540_15_ * 3.1415927f / p_151540_16_) * p_151540_12_ * 1.0f;
            ...
            if (flag1 || random.nextInt(4) != 0) {
                ...
                if (p_151540_6_ >= d4 - 16.0 - d12 * 2.0 && p_151540_10_ >= d5 - 16.0 - d12 * 2.0 && p_151540_6_ <= d4 + 16.0 + d12 * 2.0 && p_151540_10_ <= d5 + 16.0 + d12 * 2.0) {
                    ...
                    if (!flag2) {
                        for (k2 = i4; k2 < l1; ++k2) {
                            double d13 = (k2 + p_151540_3_ * 16 + 0.5 - p_151540_6_) / d12;
                            for (j3 = k4; j3 < j2; ++j3) {
                                double d14 = (j3 + p_151540_4_ * 16 + 0.5 - p_151540_10_) / d12;
                                ...
                                for (int l3 = i2 - 1; l3 >= j4; --l3) {
                                    double d11 = (l3 + 0.5 - p_151540_8_) / d6;
                                    if ((d13 * d13 + d14 * d14) * this.field_75046_d[l3] + d11 * d11 / 6.0 < 1.0) {
    ...
    private boolean isTopBlock(Block[] data, int index, int x, int y, int z, int chunkX, int chunkZ) {
        ...
        return this.isExceptionBiome(biome) ? data[index] == BlockRegister.getRegisteredBlock("geonosisGravel") : data[index] == biome.topBlock;
    }
