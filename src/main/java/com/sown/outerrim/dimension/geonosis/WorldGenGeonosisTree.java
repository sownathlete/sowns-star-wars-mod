...
public class WorldGenGeonosisTree
extends WorldGenAbstractTree {
    ...
    public WorldGenGeonosisTree(boolean par1, int par2, int par3, int par4, boolean par5, Block sapling, Block log, Block leaf) {
        super(false);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5) {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256) {
            ...
            boolean isSoil = block2.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, ((BlockSapling)this.sapling));
                ...
                for (k1 = par4 - b0 + l; k1 <= par4 + l; ++k1) {
                    ...
                    for (i2 = par3 - l1; i2 <= par3 + l1; ++i2) {
                        ...
                        for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2) {
                            Block block1;
                            int l2 = k2 - par5;
                            if (Math.abs(j2) == l1 && Math.abs(l2) == l1 && (par2Random.nextInt(2) == 0 || i3 == 0) || !(block1 = par1World.getBlock(i2, k1, k2)).isAir(par1World, i2, k1, k2) && !block1.isLeaves(par1World, i2, k1, k2)) {
                                continue;
                            }
