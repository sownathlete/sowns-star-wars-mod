...
extends BiomeGenBase {
    ...
    public static final BiomeGenBase ilum = new BiomeGenIlumPlains().setColor(112).setBiomeName("Ilum Plains").setHeight(height_ilumDesert);
    public static final BiomeGenBase ilumMountains = new BiomeGenIlumMountains(OuterRimResources.ConfigOptions.biomeIlumMountainsId).setColor(112).setBiomeName("Ilum Mountains").setHeight(height_ilumMountains);
    ...
    static {
        biomes.add(ilum);
        biomes.add(ilumMountains);
        // Add other biomes as needed
    }

    public IlumBiomes(int id) {
        super(id);
    ...
    public BiomeDecorator createBiomeDecorator() {
        return new BiomeDecoratorIlum();
    }

    protected BiomeDecoratorIlum getBiomeDecorator() {
        return (BiomeDecoratorIlum)this.theBiomeDecorator;
    }
