...
public class JakkuProvider
extends WorldProviderSpace{
    public static final BiomeGenBase jakku = new BiomeGenJakku(OuterRimResources.ConfigOptions.biomeJakkuId).setColor(112).setBiomeName("Jakku");
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderJakku.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerJakku.class;
    }
