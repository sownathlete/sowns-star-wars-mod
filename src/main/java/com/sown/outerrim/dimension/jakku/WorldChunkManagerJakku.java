...
public class WorldChunkManagerJakku
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerJakku() {
        this.biomesToSpawn.add(JakkuProvider.jakku);
    }

    public WorldChunkManagerJakku(long seed) {
        this();
    }

    public WorldChunkManagerJakku(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return JakkuProvider.jakku;
    }
