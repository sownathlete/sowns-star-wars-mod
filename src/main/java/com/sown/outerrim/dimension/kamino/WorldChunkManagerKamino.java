...
public class WorldChunkManagerKamino
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerKamino() {
        this.biomesToSpawn.add(KaminoProvider.kamino);
    }

    public WorldChunkManagerKamino(long seed) {
        this();
    }

    public WorldChunkManagerKamino(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return KaminoProvider.kamino;
    }
