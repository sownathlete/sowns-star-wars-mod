...
public class ChunkProviderKessel
extends ChunkProviderDryPreset {
    ...
    public ChunkProviderKessel(World world, long seed, boolean features) {
    ...
    public Chunk provideChunk(int par1, int par2) {
        ...
        for (int i = 0; i < ablock.length; i++) {
            if (ablock[i] == Blocks.water) {
                ablock[i] = FluidRegister.getRegisteredFluidBlock("liquid_acid"); // Replace with air or any other block you prefer
            }
        }
