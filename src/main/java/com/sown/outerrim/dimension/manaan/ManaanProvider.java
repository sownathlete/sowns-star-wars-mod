...
public class ManaanProvider
extends WorldProviderSpace{
    public static final BiomeGenBase manaan = new BiomeGenManaan(OuterRimResources.ConfigOptions.biomeManaanId).setColor(112).setBiomeName("Manaan");
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderManaan.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerManaan.class;
    }
