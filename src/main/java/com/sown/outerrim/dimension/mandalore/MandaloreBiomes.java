...
public class MandaloreBiomes
extends BiomeGenBase {
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    protected static final BiomeGenBase.Height height_mandaloreDesert = new BiomeGenBase.Height(0.1F, 0.0F);
    protected static final BiomeGenBase.Height height_mandaloreWastes = new BiomeGenBase.Height(0.2F, 0.05F);
    protected static final BiomeGenBase.Height height_mandalorePlateau = new BiomeGenBase.Height(1.5F, 0.4F);
    public static final BiomeGenBase mandalore = new BiomeGenMandaloreDesert().setColor(112).setBiomeName("Mandalore Desert").setHeight(height_mandaloreDesert);
    ...
    static {
        biomes.add(mandalore);
        // Add other biomes as needed
    }

    public MandaloreBiomes(int id) {
        super(id);
    ...
    public BiomeDecorator createBiomeDecorator() {
        return new BiomeDecoratorMandalore();
    }

    protected BiomeDecoratorMandalore getBiomeDecorator() {
        return (BiomeDecoratorMandalore)this.theBiomeDecorator;
    }
