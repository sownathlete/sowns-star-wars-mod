...
public class WorldChunkManagerMimban
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerMimban() {
        this.biomesToSpawn.add(MimbanProvider.mimban);
    }

    public WorldChunkManagerMimban(long seed) {
        this();
    }

    public WorldChunkManagerMimban(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return MimbanProvider.mimban;
    }
