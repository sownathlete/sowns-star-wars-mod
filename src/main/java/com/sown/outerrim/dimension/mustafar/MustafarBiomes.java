...
extends BiomeGenBase {
    ...
    protected static final BiomeGenBase.Height height_Mustafar = new BiomeGenBase.Height(0.03F, 0.35F);
    public static final BiomeGenBase mustafarPlateau = new BiomeGenMustafar(OuterRimResources.ConfigOptions.biomeMustafarPlateauId, false, false).setColor(112).setBiomeName("Mustafar Mountains").setHeight(height_Mustafar);
    ...
    static {
        biomes.add(mustafarPlateau);
        // Add other biomes as needed
    }

    public MustafarBiomes(int id) {
        super(id);
        ...
        this.fillerMeta = 0;
        this.stoneBlock = BlockRegister.getRegisteredBlock("mustafarRock");
        this.stoneMeta = 1;
    ...
    public BiomeDecorator createBiomeDecorator() {
        return new BiomeDecoratorMustafar();
    }

    protected BiomeDecoratorMustafar getBiomeDecorator() {
        return (BiomeDecoratorMustafar)this.theBiomeDecorator;
    }
    ...
    public void generateBiomeTerrain(World world, Random rand, Block[] block, byte[] meta, int x, int z, double stoneNoise) {
        ...
        for (int y = 255; y >= 0; --y) {
            ...
            if (currentBlock == null || currentBlock.getMaterial() == Material.air || currentBlock != BlockRegister.getRegisteredBlock("mustafarRock")) {
                continue;
            }
