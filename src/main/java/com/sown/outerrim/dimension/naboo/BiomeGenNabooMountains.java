...
public class BiomeGenNabooMountains extends BiomeGenBase {
    ...
    public BiomeGenNabooMountains(int p_i1986_1_) {
        super(p_i1986_1_);
        this.setTemperatureRainfall(0.8F, 0.8F);  // More rainfall to make it lush
        this.setHeight(height_HighPlateaus);  // Gentle hills instead of mid hills
        this.theBiomeDecorator.treesPerChunk = 2;  // Introduce trees
        this.theBiomeDecorator.flowersPerChunk = 6;  // More flowers
        this.theBiomeDecorator.grassPerChunk = 15;  // Lush grass
        this.theBiomeDecorator.waterlilyPerChunk = 4;  // Introduce water lilies for water bodies
        this.spawnableCreatureList.clear();
        this.spawnableMonsterList.clear();
        this.flowers.clear();
        // Modified flower distribution to represent Naboo's unique flora
        this.addFlower(Blocks.red_flower, 0, 8);
        this.addFlower(Blocks.red_flower, 3, 8);
        this.addFlower(Blocks.red_flower, 8, 8);
        this.addFlower(Blocks.yellow_flower, 0, 10);
    }
    ...
    {
        BiomeGenNabooMountains biomegenplains = new BiomeGenNabooMountains(this.biomeID + 128);
