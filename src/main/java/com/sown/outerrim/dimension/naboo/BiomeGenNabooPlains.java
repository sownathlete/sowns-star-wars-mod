...
public class BiomeGenNabooPlains extends BiomeGenBase {
    ...
    public BiomeGenNabooPlains(int p_i1986_1_) {
        ...
        this.setHeight(height_MidHills);  // Gentle hills instead of mid hills
        this.theBiomeDecorator.treesPerChunk = 10;  // Introduce trees
    ...
    {
        BiomeGenNabooPlains biomegenplains = new BiomeGenNabooPlains(this.biomeID + 128);
