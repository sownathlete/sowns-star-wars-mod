...
public class GenLayerBiomeNaboo extends GenLayer {

    public GenLayerBiomeNaboo(long seed) {
        super(seed);
    }
        ...
        for (int y = 0; y < areaHeight; y++) {
            for (int x = 0; x < areaWidth; x++) {
                ...
                if (nextInt < 30) {  // 30% chance
                    ...
                    biomes[x + y * areaWidth] = OuterRimResources.ConfigOptions.biomeNabooGreatPlainsId;
                } else if (nextInt < 88) {  // 23% chance
                    biomes[x + y * areaWidth] = OuterRimResources.ConfigOptions.biomeNabooPlainsId;
                } else if (nextInt < 99) {  // 11% chance
                    biomes[x + y * areaWidth] = OuterRimResources.ConfigOptions.biomeNabooMountainsId;
                } else {  // 1% chance
    ...
    public static GenLayer[] makeTheWorld(long seed) {
        GenLayer biomes = new GenLayerNabooBiomes(1L);
