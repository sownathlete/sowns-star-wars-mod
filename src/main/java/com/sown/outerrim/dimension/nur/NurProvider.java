...
public class NurProvider
extends WorldProviderSpace{
    public static final BiomeGenBase nur = new BiomeGenNur(OuterRimResources.ConfigOptions.biomeNurId).setColor(112).setBiomeName("Nur");
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderNur.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerNur.class;
    }
