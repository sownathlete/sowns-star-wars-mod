...
public class WorldChunkManagerNur
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerNur() {
        this.biomesToSpawn.add(NurProvider.nur);
    }

    public WorldChunkManagerNur(long seed) {
        this();
    }

    public WorldChunkManagerNur(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return NurProvider.nur;
    }
