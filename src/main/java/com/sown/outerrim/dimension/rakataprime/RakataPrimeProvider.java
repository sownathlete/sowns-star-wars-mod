...
public class RakataPrimeProvider
extends WorldProviderSpace
implements WorldProviderHelper {
    public static final BiomeGenBase rakataPrime = new BiomeGenRakataPrime(OuterRimResources.ConfigOptions.biomeRakataPrimeId).setColor(112).setBiomeName("RakataPrime");
    ...
    public void registerWorldChunkManager() {
        this.worldChunkMgr = new WorldChunkManagerRakataPrime();
        this.dimensionId = OuterRimResources.ConfigOptions.dimRakataPrimeId;
    }
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderRakataPrime.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerRakataPrime.class;
    }
