...
public class RylothBiomes
extends BiomeGenBase {
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    protected static final BiomeGenBase.Height height_rylothWastes = new BiomeGenBase.Height(2.0F, 0.05F);
    protected static final BiomeGenBase.Height height_desert = new BiomeGenBase.Height(0.1F, 0.0F);
    public static final BiomeGenBase ryloth = new BiomeGenRylothDesert1().setColor(112).setBiomeName("Ryloth Dusty Flats").setHeight(height_LowPlains);
    public static final BiomeGenBase rylothPlateau = new BiomeGenRylothWastes(OuterRimResources.ConfigOptions.biomeRylothPlateauId, false, false).setColor(112).setBiomeName("Ryloth Plateau").setHeight(height_rylothWastes);
    ...
    static {
        biomes.add(ryloth);
        biomes.add(rylothPlateau);
        // Add other biomes as needed
    }

    public RylothBiomes(int id) {
        super(id);
    ...
    public BiomeDecorator createBiomeDecorator() {
        return new BiomeDecoratorRyloth();
    }

    protected BiomeDecoratorRyloth getBiomeDecorator() {
        return (BiomeDecoratorRyloth)this.theBiomeDecorator;
    }
