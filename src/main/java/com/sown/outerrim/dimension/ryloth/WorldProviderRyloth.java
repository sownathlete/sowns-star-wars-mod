...
public class WorldProviderRyloth extends WorldProviderSpace implements WorldProviderHelper {
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return ChunkProviderRyloth.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerRyloth.class;
    }
