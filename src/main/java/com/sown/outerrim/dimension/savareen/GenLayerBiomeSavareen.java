...
public class GenLayerBiomeSavareen extends GenLayer {

    public GenLayerBiomeSavareen(long seed) {
        super(seed);
    }
        ...
        for (int y = 0; y < areaHeight; y++) {
            for (int x = 0; x < areaWidth; x++) {
                ...
                if (nextInt < 30) {  // 30% chance
                    biomes[x + y * areaWidth] = BiomeGenBase.beach.biomeID;
    ...
    public static GenLayer[] makeTheWorld(long seed) {
        GenLayer biomes = new GenLayerSavareenBiomes(1L);
