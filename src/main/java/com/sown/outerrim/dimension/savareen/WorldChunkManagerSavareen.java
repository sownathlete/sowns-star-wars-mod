...
public class WorldChunkManagerSavareen
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerSavareen() {
        this.biomesToSpawn.add(BiomeGenBase.beach);
    }

    public WorldChunkManagerSavareen(long seed) {
        this();
        GenLayer[] agenlayer = GenLayerBiomeSavareen.makeTheWorld(seed);
        this.unzoomedBiomes = agenlayer[0];
        this.zoomedBiomes = agenlayer[1];
    }

    public WorldChunkManagerSavareen(World world) {
        this(world.getSeed());
    }
