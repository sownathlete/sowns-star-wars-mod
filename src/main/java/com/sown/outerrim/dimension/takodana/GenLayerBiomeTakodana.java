...
public class GenLayerBiomeTakodana extends GenLayer {

    public GenLayerBiomeTakodana(long seed) {
        super(seed);
    }
        ...
        for (int y = 0; y < areaHeight; y++) {
            for (int x = 0; x < areaWidth; x++) {
                ...
                if (nextInt < 30) { 
                    ...
                    biomes[x + y * areaWidth] = BiomeGenBase.extremeHillsEdge.biomeID;
                }
            }
        }
    ...
    public static GenLayer[] makeTheWorld(long seed) {
        GenLayer biomes = new GenLayerTakodanaBiomes(1L);
