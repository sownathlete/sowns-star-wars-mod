...
public class TarisProvider
extends WorldProviderSpace{
    public static final BiomeGenBase taris = new BiomeGenTaris(OuterRimResources.ConfigOptions.biomeTarisId).setColor(112).setBiomeName("Taris");
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderTaris.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerTaris.class;
    }
