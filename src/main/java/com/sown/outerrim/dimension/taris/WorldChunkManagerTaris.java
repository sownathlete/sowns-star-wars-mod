...
public class WorldChunkManagerTaris
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerTaris() {
        this.biomesToSpawn.add(TarisProvider.taris);
    }

    public WorldChunkManagerTaris(long seed) {
        this();
    }

    public WorldChunkManagerTaris(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return TarisProvider.taris;
    }
