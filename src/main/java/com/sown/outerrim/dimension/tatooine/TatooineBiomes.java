...
public class TatooineBiomes
extends BiomeGenBase {
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    protected static final BiomeGenBase.Height height_tatooineWastes = new BiomeGenBase.Height(3.0F, 0.05F);
    protected static final BiomeGenBase.Height height_desert = new BiomeGenBase.Height(0.1F, 0.0F);
    public static final BiomeGenBase tatooineDesert = new BiomeGenTatooineDesert().setColor(112).setBiomeName("Tatooine Dune Sea").setHeight(height_desert);
    public static final BiomeGenBase tatooineMountains = new BiomeGenTatooineMountains(OuterRimResources.ConfigOptions.biomeTatooineMountainsId, false, false).setColor(112).setBiomeName("Tatooine Mountains").setHeight(height_tatooineWastes);
    ...
    static {
        biomes.add(tatooineDesert);
        biomes.add(tatooineMountains);
    }

    public TatooineBiomes(int id) {
        super(id);
    ...
    public BiomeDecorator createBiomeDecorator() {
        return new BiomeDecoratorTatooine();
    }

    protected BiomeDecoratorTatooine getBiomeDecorator() {
        return (BiomeDecoratorTatooine)this.theBiomeDecorator;
    }
