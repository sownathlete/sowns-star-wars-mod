...
public class TythonBiomes
extends BiomeGenBase {
    public static final List<BiomeGenBase> biomes = new ArrayList<>();
    protected static final BiomeGenBase.Height height_ilumDesert = new BiomeGenBase.Height(0.1F, 0.0F);
    protected static final BiomeGenBase.Height height_ilumMountains = new BiomeGenBase.Height(1.5F, 0.4F);
    public static final BiomeGenBase tythonForest = new BiomeGenTythonForest(OuterRimResources.ConfigOptions.biomeTythonForestId).setColor(112).setBiomeName("Tython Forest");
    public static final BiomeGenBase tythonMountains = new BiomeGenTythonMountains(OuterRimResources.ConfigOptions.biomeTythonMountainsId).setColor(112).setBiomeName("Tython Mountains");
    ...
    static {
        biomes.add(tythonForest);
        biomes.add(tythonMountains);
        // Add other biomes as needed
    }

    public TythonBiomes(int id) {
        super(id);
    ...
    public BiomeDecorator createBiomeDecorator() {
        return new BiomeDecoratorTython();
    }

    protected BiomeDecoratorTython getBiomeDecorator() {
        return (BiomeDecoratorTython)this.theBiomeDecorator;
    }
