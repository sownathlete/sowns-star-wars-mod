...
public class WorldProviderTython extends WorldProviderSpace implements WorldProviderHelper {
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return ChunkProviderTython.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerTython.class;
    }
    ...
    public IRenderHandler getSkyRenderer() {
        ...
        if (Loader.isModLoaded("legends")) {
            try {
                // Dynamically load the TythonSkyRender class
                Class<?> skyRenderClass = Class.forName("com.tihyo.starwars.galactic.planets.tython.TythonSkyRender");
                return (IRenderHandler) skyRenderClass.newInstance();
            } catch (ClassNotFoundException | InstantiationException | IllegalAccessException e) {
                // Log the error or handle it appropriately
                System.err.println("TythonSkyRender class not found or could not be instantiated.");
            }
        }
