...
public class VandorProvider
extends WorldProviderSpace{
    public static final BiomeGenBase vandor = new BiomeGenVandor(OuterRimResources.ConfigOptions.biomeVandorId).setColor(112).setBiomeName("Vandor");
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerVandor.class;
    }
