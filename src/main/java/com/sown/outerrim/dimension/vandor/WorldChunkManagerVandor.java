...
public class WorldChunkManagerVandor
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerVandor() {
        this.biomesToSpawn.add(VandorProvider.vandor);
    }

    public WorldChunkManagerVandor(long seed) {
        this();
    }

    public WorldChunkManagerVandor(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return VandorProvider.vandor;
    }
