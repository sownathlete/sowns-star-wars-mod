...
public class VjunProvider
extends WorldProviderSpace{
    public static final BiomeGenBase vjun = new BiomeGenVjun(OuterRimResources.ConfigOptions.biomeVjunId).setColor(112).setBiomeName("Vjun");
    ...
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerVjun.class;
    }
