...
public class WorldChunkManagerVjun
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerVjun() {
        this.biomesToSpawn.add(VjunProvider.vjun);
    }

    public WorldChunkManagerVjun(long seed) {
        this();
    }

    public WorldChunkManagerVjun(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return VjunProvider.vjun;
    }
