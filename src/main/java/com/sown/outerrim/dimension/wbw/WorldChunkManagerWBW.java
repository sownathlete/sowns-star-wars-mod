...
public class WorldChunkManagerWBW
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerWBW() {
        this.biomesToSpawn.add(WBWProvider.worldBetweenWorlds);
    }

    public WorldChunkManagerWBW(long seed) {
        this();
    }

    public WorldChunkManagerWBW(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return WBWProvider.worldBetweenWorlds;
    }
