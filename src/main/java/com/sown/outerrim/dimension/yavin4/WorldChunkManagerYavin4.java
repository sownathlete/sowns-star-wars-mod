...
public class WorldChunkManagerYavin4
extends DimensionHelperChunkMgr {
    ...
    protected WorldChunkManagerYavin4() {
        this.biomesToSpawn.add(Yavin4Provider.yavin4);
    }

    public WorldChunkManagerYavin4(long seed) {
        this();
    }

    public WorldChunkManagerYavin4(World world) {
        this(world.getSeed());
    }

    @Override
    public BiomeGenBase getBiome() {
        return Yavin4Provider.yavin4;
    }
