...
public class Yavin4Provider
extends WorldProviderSpace{
    public static final BiomeGenBase yavin4 = new BiomeGenYavin4(OuterRimResources.ConfigOptions.biomeYavin4Id).setColor(112).setBiomeName("Yavin 4");
    ...
    public Class<? extends IChunkProvider> getChunkProviderClass() {
        return BiomeChunkProviderYavin4.class;
    }

    @Override
    public Class<? extends WorldChunkManager> getWorldChunkManagerClass() {
        return WorldChunkManagerYavin4.class;
    }
