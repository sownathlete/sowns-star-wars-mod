...
public class EntityLaserProjectileRed extends EntityArrow {
    ...
    public void onUpdate() {
        ...
        MovingObjectPosition movingObjectPosition = this.worldObj.rayTraceBlocks(startVec, endVec, false); // Use correct method
        ...
        if (movingObjectPosition != null && movingObjectPosition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            if (hitBlock.isReplaceable(this.worldObj, x, y, z)) {
                movingObjectPosition = null; // Null out the collision to ignore it
            }
        }
