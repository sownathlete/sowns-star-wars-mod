...
public class EntityTuskenRaider
extends EntityTameable{
    public AiFollowEntity aiFollowEntity;

    public EntityTuskenRaider(World worldIn) {
        super(worldIn);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (entity instanceof EntityPlayer) {
            ...
            for (Entity nearbyEntity : nearbyEntities) {
                if (nearbyEntity instanceof EntityTuskenRaider) {
                    EntityTuskenRaider nearbyTuskenRaider = (EntityTuskenRaider) nearbyEntity;
	...
	public void onDeath(DamageSource cause) {
	    ...
	    if (!this.worldObj.isRemote) {
	        ...
	        this.dropItem(Items.rotten_flesh, this.rand.nextInt(2) + 1);
    ...
    public EntityAgeable createChild(EntityAgeable ageable) {
        EntityTuskenRaider child = new EntityTuskenRaider(this.worldObj);
        if (this.isTamed()) {
            child.setTamed(true);
