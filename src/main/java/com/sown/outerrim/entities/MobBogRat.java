...
public class MobBogRat extends EntityTameable
{
    ...
    public MobBogRat(World p_i1696_1_) {
        ...
        // Make the BogRat attack players
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, true));
        this.targetTasks.addTask(2, new EntityAITargetNonTamed(this, EntityPlayer.class, 200, false));
        this.setAngry(true);
    }
    ...
    public MobBogRat createChild(EntityAgeable p_90011_1_)
    {
        MobBogRat entitywolf = new MobBogRat(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof MobBogRat))
        {
            return false;
        }
        else
        {
            MobBogRat entitywolf = (MobBogRat)p_70878_1_;
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof MobBogRat)
            {
                MobBogRat entitywolf = (MobBogRat)p_142018_1_;
