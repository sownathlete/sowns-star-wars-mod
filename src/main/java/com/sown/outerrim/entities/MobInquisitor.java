...
public class MobInquisitor
extends EntityCreature{
    public AiFollowEntity aiFollowEntity;

    public MobInquisitor(World worldIn) {
        super(worldIn);
    ...
    private void equipArmor() {
        if (rand.nextFloat() < 0.9f) { // 90% chance to equip helmet, can adjust this probability
            this.setCurrentItemOrArmor(4, new ItemStack(ItemRegister.getRegisteredItem("inquisitorHelmet")));
        }
        this.setCurrentItemOrArmor(3, new ItemStack(ItemRegister.getRegisteredItem("inquisitorChestplate")));
        this.setCurrentItemOrArmor(2, new ItemStack(ItemRegister.getRegisteredItem("inquisitorLeggings")));
        this.setCurrentItemOrArmor(1, new ItemStack(ItemRegister.getRegisteredItem("inquisitorBoots")));
    }
