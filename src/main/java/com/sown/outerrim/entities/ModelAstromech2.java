 ...
 */
public class ModelAstromech2 extends ModelBase {
    ...
    public ModelAstromech2() {
        ...
        this.neck = new ModelRenderer(this, 32, 2);
        this.neck.setRotationPoint(1.0F, -1.0F, 1.0F);
        this.neck.addBox(0.0F, 0.0F, 0.0F, 6, 1, 6, 0.0F);
        this.head = new ModelRenderer(this, 0, 13);
        this.head.setRotationPoint(4.0F, -6.0F, 4.0F);
        ...
        this.antenna = new ModelRenderer(this, 1, 3);
        this.antenna.mirror = true;
        this.antenna.setRotationPoint(-3.0F, -4.0F, 0.0F);
        this.antenna.addBox(0.0F, 0.0F, 0.0F, 0, 4, 1, 0.0F);
