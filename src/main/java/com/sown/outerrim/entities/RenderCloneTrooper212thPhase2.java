...
public class RenderCloneTrooper212thPhase2 extends RenderLiving {
    ...
    public static final ResourceLocation texture = new ResourceLocation("outerrim", "textures/models/species/human/clone/212th/phase2.png");

    // Constructor to set the model and shadow size
    public RenderCloneTrooper212thPhase2(ModelBase model, float shadowSize) {
    ...
    protected void preRenderCallback(EntityLivingBase entity, float partialTickTime) {
        if (entity instanceof MobCloneTrooper212thPhase2) {
            MobCloneTrooper212thPhase2 trooper = (MobCloneTrooper212thPhase2) entity;
