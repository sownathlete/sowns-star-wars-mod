...
public class RenderCloneTrooper41stPhase2 extends RenderLiving {
    // Texture for the clone trooper phase 2
    public static final ResourceLocation texture = new ResourceLocation("outerrim", "textures/models/species/human/clone/41st/phase2.png");

    // Constructor to set the model and shadow size
    public RenderCloneTrooper41stPhase2(ModelBase model, float shadowSize) {
    ...
    protected void preRenderCallback(EntityLivingBase entity, float partialTickTime) {
        if (entity instanceof MobCloneTrooper41stPhase2) {
            MobCloneTrooper41stPhase2 trooper = (MobCloneTrooper41stPhase2) entity;
