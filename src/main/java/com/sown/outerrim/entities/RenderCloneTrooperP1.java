...
public class RenderCloneTrooperP1 extends RenderBiped {
    public static ResourceLocation texture = new ResourceLocation("outerrim", "textures/models/species/human/clone/male/base.png");

    public RenderCloneTrooperP1(ModelBiped par1ModelBase, float par2) {
        super(par1ModelBase, par2);
    }

    protected ResourceLocation getEntityTexture(Entity entity) {
        if (entity instanceof MobCloneTrooperP1) {
        	MobCloneTrooperP1 steve = (MobCloneTrooperP1) entity;
