...
public class RenderCloneTrooperPhase2 extends RenderLiving {
    // Texture for the clone trooper phase 2
    public static final ResourceLocation texture = new ResourceLocation("outerrim", "textures/models/species/clone/phase2.png");

    // Constructor to set the model and shadow size
    public RenderCloneTrooperPhase2(ModelBase model, float shadowSize) {
    ...
    protected void preRenderCallback(EntityLivingBase entity, float partialTickTime) {
        if (entity instanceof MobCloneTrooperPhase2) {
            MobCloneTrooperPhase2 trooper = (MobCloneTrooperPhase2) entity;
