...
public class ItemRendererPortableCoaxiumExtractor implements IItemRenderer {

	private final RenderPortableCoaxiumExtractorTESR tesr = new RenderPortableCoaxiumExtractorTESR();
	private final TileEntityPortableCoaxiumPump dummy = new TileEntityPortableCoaxiumPump();

	public ItemRendererPortableCoaxiumExtractor() {
	...
	public void renderItem(ItemRenderType type, ItemStack stack, Object... data) {
		...
		switch (type) {
		case INVENTORY:
			GL11.glScalef(0.718f, 0.718f, 0.718f);
			GL11.glTranslatef(-0.375f, -1.4125f, 0f);
