...
public class RenderBlockCoaxiumContainer implements IItemRenderer {
    // your TESR that knows how to draw the 3D model + texture
    private final TileEntitySpecialRenderer tesr = new RenderCoaxiumContainerTESR();
    // a dummy TE instance to pass into the TESR
    private final TileEntityCoaxiumContainer dummyTE = new TileEntityCoaxiumContainer();

    public RenderBlockCoaxiumContainer() {
