...
public class RenderBlockVenatorBridgeMechanicalTable
implements IItemRenderer {
    private TileEntitySpecialRenderer render = new RenderVenatorBridgeMechanicalTable();
    private TileEntity tile = new TileEntityVenatorBridgeMechanicalTable();

    public RenderBlockVenatorBridgeMechanicalTable() {
