...
public class RenderItemCarbonite implements IItemRenderer {
    private TileEntitySpecialRenderer render = new RenderBlockCarbonite();
    private TileEntity tile = new TileEntityCarbonite();

    public RenderItemCarbonite() {
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack item, Object ... data) {
        ...
        switch (type) {
            case INVENTORY: {
            	...
            	GL11.glTranslatef(0.03f, -0.505f, 0.0f);
            	GL11.glRotatef(90.0f, 0.0f, 1.0f, 0.0f);
            	P3D.glScalef(0.5f);
            	GL11.glScalef(1.0f, 1.0f, -1.0f);
            	GL11.glTranslatef(-0.03f, -0.825f, 0.0f);
