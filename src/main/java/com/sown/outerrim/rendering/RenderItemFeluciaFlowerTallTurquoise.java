...
public class RenderItemFeluciaFlowerTallTurquoise implements IItemRenderer {
    private final TileEntitySpecialRenderer tesr = new RenderBlockFeluciaFlowerTallTurquoise();
    private final TileEntityFeluciaFlowerTurquoise dummyTE = new TileEntityFeluciaFlowerTurquoise();

    public RenderItemFeluciaFlowerTallTurquoise() {
