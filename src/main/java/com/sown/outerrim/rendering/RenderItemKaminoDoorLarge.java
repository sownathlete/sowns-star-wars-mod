...
public class RenderItemKaminoDoorLarge implements IItemRenderer {
    private TileEntitySpecialRenderer render;
    private TileEntityKaminoDoorLarge tileEntity;

    public RenderItemKaminoDoorLarge() {
        // Initialize the tileEntity and render objects
        this.tileEntity = new TileEntityKaminoDoorLarge();
        this.render = new RenderBlockKaminoDoorLarge();
    }
