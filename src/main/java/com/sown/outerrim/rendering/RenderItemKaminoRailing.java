...
public class RenderItemKaminoRailing implements IItemRenderer {
    private TileEntitySpecialRenderer render = new RenderBlockKaminoRailing();
    private TileEntity tile = new TileEntityKaminoRailing();

    public RenderItemKaminoRailing() {
