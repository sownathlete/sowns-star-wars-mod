...
public class RenderItemMediumCoaxiumPump implements IItemRenderer {
	private final TileEntitySpecialRenderer tesr = new RenderBlockMediumCoaxiumPump();
	private final TileEntityMediumCoaxiumPump dummyTE = new TileEntityMediumCoaxiumPump();

	public RenderItemMediumCoaxiumPump() {
