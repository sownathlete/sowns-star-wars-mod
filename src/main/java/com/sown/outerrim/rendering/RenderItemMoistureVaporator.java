...
public class RenderItemMoistureVaporator implements IItemRenderer {
    private TileEntitySpecialRenderer render;
    private TileEntityMoistureVaporator tileEntity;

    public RenderItemMoistureVaporator() {
        // Initialize the tileEntity and render objects
        this.tileEntity = new TileEntityMoistureVaporator();
        this.render = new RenderBlockMoistureVaporator();
    }
