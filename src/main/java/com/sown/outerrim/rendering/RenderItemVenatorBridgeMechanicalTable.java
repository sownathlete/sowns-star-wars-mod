...
public class RenderItemVenatorBridgeMechanicalTable implements IItemRenderer {
    private TileEntitySpecialRenderer render = new RenderBlockVenatorBridgeMechanicalTable();
    private TileEntity tile = new TileEntityVenatorBridgeMechanicalTable();

    public RenderItemVenatorBridgeMechanicalTable() {
