...
public class RenderItemVenatorScreen implements IItemRenderer {
    private TileEntitySpecialRenderer render;
    private TileEntityVenatorScreen tileEntity;

    public RenderItemVenatorScreen() {
        // Initialize the tileEntity and render objects
        this.tileEntity = new TileEntityVenatorScreen();
        this.render = new RenderBlockVenatorScreen();
    }
