...
public abstract class ChunkProviderLavaPreset extends ChunkProviderGenerate {
    ...
    public final GradientUtil noiseGen;

    public ChunkProviderLavaPreset(World world, long seed, boolean flag) {
        ...
        this.noiseGen = new GradientUtil(this.rand.nextLong(), 1, 0.25F);
    }
    ...
    public abstract void decoratePlanet(World paramWorld, Random paramRandom, int paramInt1, int paramInt2);

    protected abstract List<MapGenBaseMeta> getWorldGenerators();

    public abstract void onChunkProvide(int paramInt1, int paramInt2, Block[] paramArrayOfBlock, byte[] paramArrayOfbyte);
}
