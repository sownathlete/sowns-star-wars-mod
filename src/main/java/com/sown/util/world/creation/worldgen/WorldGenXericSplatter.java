...
public class WorldGenXericSplatter
extends WorldGeneratorOR {
    ...
    public boolean generate(World world, Random random, int x, int y, int z) {
        ...
        for (int var7 = 0; var7 < 128; ++var7) {
            ...
            if (!world.isAirBlock(randX, randY, randZ) || world.getBlock(randX, randY - 1, randZ) != Blocks.sand && world.getBlock(randX, randY - 1, randZ) != BlockRegister.getRegisteredBlock("mud") && world.getBlock(randX, randY - 1, randZ) != Blocks.dirt && world.getBlock(randX, randY - 1, randZ) != Blocks.sand && world.getBlock(randX, randY - 1, randZ) != Blocks.stone) {
                continue;
            }
            world.setBlock(randX, randY - 1, randZ, Blocks.grass, 0, 2);
            if (var999 == 0) {
                world.setBlock(randX, randY, randZ, Blocks.yellow_flower, 7, 2);
                continue;
            }
            if (var999 == 2) {
            ...
            if (var999 == 7) {
                world.setBlock(randX, randY, randZ, Blocks.tallgrass, 9, 2);
                continue;
            }
            world.setBlock(randX, randY, randZ, Blocks.tallgrass, 4, 2);
        }
        return true;
    }
